...
public final class ColumnMapping
{
    ...
    {
        return blockMapping(prestoType, readFunction, writeFunction, FULL_PUSHDOWN);
    }

    public static ColumnMapping blockMapping(Type prestoType, BlockReadFunction readFunction, BlockWriteFunction writeFunction, PredicatePushdownController pushdownConverter)
    {
